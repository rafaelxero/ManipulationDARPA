\section{HRP-2Kai humanoid robot}
	...
	tasks: a 3D scanner system built in its head, four cameras placed at the head, at the back and at
	each hand, and six-axis force sensors on its wrists and ankles.
	...
	The wrist force sensors were used for task control, specifically to detect hand contact with the
	environment, as expressed in Sections \ref{sub:GraspLever} and \ref{sub:GraspPlug}.
	The ankle force sensors were used for biped walk stabilization.

	\begin{figure}[t]
		\begin{center}
			\subfloat[Actual robot.]{\label{fig:HRP2Kai-robot}
				\includegraphics[height = 4.65cm]{img/HRP2Kai-robot}}
			\hspace{1cm}
			\subfloat[Structure.]{\label{fig:HRP2Kai-structure}
				\includegraphics[height = 4.65cm]{img/HRP2Kai-structure}}
		\end{center}
